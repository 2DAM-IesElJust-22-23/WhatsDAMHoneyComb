...
public class communicationManager {
    ...
    public static JSONObject sendServer(String msg) {
        ...
        try {
           ...
           pw.close();
            ...
            System.out.println("La conexió no se ha pogut establir.");
    ...
    public static void connect() throws JSONException, communicationManagerException {
       ...
       // String missatge = CurrentConfig.username() + ", " + CurrentConfig.listenPort();

        JSONObject ordreRegistre = new JSONObject();

        //ordreRegistre.put("register", missatge);
        ordreRegistre.put("type", "register");
        ordreRegistre.put("user", CurrentConfig.username());
        ordreRegistre.put("listenPort", CurrentConfig.listenPort());
    ...
    public static void sendMessage(Message m) {
        ...
        JSONObject Message = m.toJSONCommand();
        String content=Message.getString("content");
        System.out.println(content);
        ordreMessage.put("type","newMessage");
        ordreMessage.put("user", CurrentConfig.username());
        ordreMessage.put("content", content);
